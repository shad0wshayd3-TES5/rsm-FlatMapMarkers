...
public:
	...
	static inline std::map<Json2Settings::string_t, std::pair<Json2Settings::boolean_t, Json2Settings::float_t>, CIComp> worldSpaces;
...
private:
	...
	static inline Json2Settings::aSetting<WhitelistedWorldspace> whiteListedWorldSpaces{ "whiteListedWorldSpaces" };
};
